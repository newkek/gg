...
// Checks to be made before any command is started.
exports.start = function() {
	// Check if a Git repository.
	exec('git status', function(error, stdout, stderr) {
		if (stderr.length !== 0) { // Not a Git repository.
			console.log(whoops('Not a Git repository.') + chalk.red(' Please initialize a new respository or clone an existing repository.'));
